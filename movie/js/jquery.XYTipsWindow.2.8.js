	...
	$.extend($.XYTipsWindow,{
		...
		showBox: function(o) {
			...
			var $boxDom = "<div id=\""+o.___boxID+"\" class=\"XYTipsWindow\">";
				...
				if(o.___closeBox){
					...
					$boxDom += "<div class=\"___boxTitle\"><h3></h3></div>";
				}
				$boxDom += "<div class=\"___boxContent\"></div>";
				$boxDom += "<div class=\"___boxDialog fr\"></div>";
				$boxDom += "</div>";
			...
			$boxDialogHeight = o.___button!="" ? 45 : -9;
			...
			var $boxBg = $(".___boxBd",$box);
				$boxBg.css({
					position: "absolute",
					width:$width+12+"px",
					height:$height+$titleHeight+$borderHeight+$boxDialogHeight+10+"px",
					left: "0",
					top: "0",
		...
		ask:function(o){
			...
			if (o.___button!=""){
				...
				return "<input class='Button_x fr' style='margin: 5px 25px 0 0;' type='button'  value='" + v + "' />";
				}).join(' '));
				$(".Button_x", $boxDialog).hover(function() {
					$(this).addClass("hover");
				},function(){
					$(this).removeClass("hover");
				}).click(function() {
